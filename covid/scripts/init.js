$(window).load(function() {
    ...
    var public_spreadsheet_url = '1XNIDpoxN-IPnc6x0P5-SLaff5PNc5lWXVEzL8Mov5bc';
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            if ($.inArray(v.filtercategory, result) == -1) {
                ...
                $('#filter').append('<button id="' + v.filtercategory + '" class="btn btn-default" data-value="choice" data-toggle="collapse"' + count++ + '">' + v.filtercategory + '</button>')
