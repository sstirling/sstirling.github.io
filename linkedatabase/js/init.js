$(window).load(function() {
    ...
    var public_spreadsheet_url = '1f91t7VXh41HAmUTva2vk45aXYMJklll3q4IyVxeuTSU';
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            $container.append('<div id="element-item"><span class="weepeople" style="color:' + v.subhed3 +';">' + v.description + '</span></div>');
            ...
            if ($.inArray(v.filtercategory, result) == -1) {
                ...
                $('#filter').append('<img src="' + v.subhed3 + '" alt=""><button id="' + v.filtercategory + '" class="btn btn-default" data-value="choice' + count++ + '">' + v.filtercategory + '</button>')
