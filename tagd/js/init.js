$(window).load(function() {
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            $container.append('<div id="element-item"><div class="headimg"><img src="' + v.img + '" width="100%"></a></div><div class="name">' + v.special + '</div><div class="boldsubhed">' + v.comedian + '</div><br>Rating:<table style="border-collapse:separate; border-spacing:3px; height:15px; width:100%;"><tr><td style="align:left; border-radius:5px; width:' + v.rtgpct + '%; background-color:' + v.rtgcolor + ';"><span style="color:#ffffff;">' + v.rating + '</span></td><td style="width:' + v.remainder1 + '%;"></td></tr></table>LOLs:<table style="border-collapse:separate; border-spacing:3px; height:15px; width:100%;"><tr><td style="align:left; border-radius:5px; width:' + v.lolpct + '%; background-color:' + v.lolcolor + ';"><span style="color:#FFFFFF;">' + v.lol + '</span></td><td style="width:' + v.remainder2 + '%;"></td></tr></table>Delivery speed:<table style="border-collapse:separate; border-spacing:3px; height:15px; width:100%;"><tr><td style="align:left; border-radius:5px; width: + v.delpct + %; background-color:' + v.delcolor + ';"><span style="color:#FFFFFF;">' + v.delivery + '</span></td><td style="width:' + v.remainder3 + '%;"></td></tr></table><div class="boldsubhed"> Style:' + v.style + '</div><div class="category"><div class="category">' + v.quality1 + '</div><div class="category"><div class="category">' + v.quality2 + '</div><div class="category"><div class="category">' + v.quality3 + '</div></div>');
