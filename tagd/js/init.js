$(window).load(function() {
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            $container.append('<div id="element-item"><div class="headimg"><img src="' + v.img + '" width="100%"></a></div><div class="name">' + v.special + '</div><div class="boldsubhed">' + v.comedian + '</div><br><table border-collapse="separate" border-spacing="1px" height="15px" width="100%"><tr><td width="10%"> Rating:</td><td style="align:left; border-radius:5px; width:' + v.rtgpct + '%; background-color:' + v.rtgcolor + ';"><span style="color:#FFF;"' + v.rating + '</td><td style="width:' + v.remainder + '%;"></td></tr><tr><td style="width:10%;"> Rating:</td><td style="align:left; border-radius:5px; width:' + v.lolpct + '%; background-color:' + v.lolcolor + ';">' + v.lol + '</td><td style="width:' + v.remainder + '%;"></td></tr><tr><td style="width:10%;"> Rating:</td><td style="align:left; border-radius:5px; width: + v.delpct + %; background-color:' + v.delcolor + ';">' + v.delivery + '</td><td style="width:' + v.remainder + '%;"></td></tr></table><div class="boldsubhed"> Style:' + v.style + '</div><div class="category"><div class="category">' + v.quality1 + '</div><div class="category"><div class="category">' + v.quality2 + '</div><div class="category"><div class="category">' + v.quality3 + '</div></div>');
