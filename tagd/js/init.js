$(window).load(function() {
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            $container.append('<div id="element-item"><div class="image-cropper"><div class="headimg"><img src="' + v.img + '" width="100%"></a></div></div><div class="name">' + v.special + '</div><div class="boldsubhed">' + v.comedian + '</div><div class="table-container"><span class="description">Rating:</span><table style="line-height:10px; width:100%;"><tr><td style="align:left; border-radius:10px; border: 0.5px; border-color:#000; height:10px; width:' + v.rtgpct + '%; background-color:' + v.rtgcolor + ';"><span style="color:#000; font-size: 12px; font-weight: bold;">&nbsp; &nbsp;' + v.rating + '</span></td><td style="width:' + v.remainder1 + '%;"></td></tr></table><span class="description">LOLs:</span><table style="line-height:10px; height:10px; width:100%;"><tr><td style="align:left; border-radius:10px; border: 0.5px; border-color:#000; width:' + v.lolpct + '%; background-color:' + v.lolcolor + ';"><span style="color:#000; font-size:12px; font-weight: bold;">&nbsp;&nbsp;' + v.lol + '</span></td><td style="width:' + v.remainder2 + '%;"></td></tr></table><span class="description">Delivery Speed:</span><table style="line-height:10px; height:10px; width:100%;"><tr><td style="align:left; border-radius:10px; border: 0.5px; border-color:#000; width: + v.delpct + %; background-color:' + v.delcolor + ';"><span style="color:#000; font-size:12px; font-weight:bold; ">&nbsp;&nbsp;' + v.delivery + '</span></td><td style="width:' + v.remainder3 + '%;"></td></tr></table></div><div class="name">Tags</div><div class="category">' + v.quality1 + '</div><div class="category">' + v.quality2 + '</div><div class="category">' + v.quality3 + '</div><div id="accordion"><div class="card"><div class="card-header" id="headingOne"><h5 class="mb-0"><button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><span class"boldsubhead">Read Full Review</span></button></h5></div><div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion"><div class="card-body">' + v.review + '</div></div></div><div class="card"><div class="card-header" id="headingTwo"><h5 class="mb-0"><button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Collapsible Group Item #2</button></h5></div><div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion"><div class="card-body">' + v.review + '</div></div></div></div></div></div>');
