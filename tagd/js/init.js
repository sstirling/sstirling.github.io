$(window).load(function() {
    ...
    function getTable(data, tabletop) {
        ...
        $.each(tabletop.sheets(sheetname).all(), function(i, v) {
            ...
            $container.append('<div id="element-item"><div class="headimg"><img src="' + v.img + '" width="100%"></a></div><div class="name">' + v.special + '</div><div class="boldsubhed">' + v.comedian + '</div><table border="0" width="100%" cellpadding = "0" cellspacing="0"><tr><td width="20%">Rating </td><td width="' + v.lolpct + '"><table border = "0" width = "100%" cellpadding = "1" cellspacing="1"><tr><td align="left" bgcolor="' + v.color +'" width="50%" height="20px;"></td><tdalign="left">' + v.lolpct + '</td></tr></table></td></tr></table><div style="' + v.rtgpct + '">' + v.rating + '</div><div style="' + v.lolpct + '">' + v.lol + '</div><div style="' + v.delpct + '">' + v.delivery + '</div><div class="boldsubhed"> Style:' + v.style + '</div><div class="category"><div class="category">' + v.quality1 + '</div><div class="category"><div class="category">' + v.quality2 + '</div><div class="category"><div class="category">' + v.quality3 + '</div></div>');
